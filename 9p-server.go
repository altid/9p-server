...
var (
	inpath   = flag.String("p", "/tmp/altid", "directory to watch")
	key      = flag.String("k", "/etc/ssl/private/altid.pem", "Path to key file for TLS")
	cert     = flag.String("c", "/etc/ssl/certs/altid.pem", "Path to cert file for TLS")
